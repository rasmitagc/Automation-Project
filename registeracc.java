...
public class registeracc extends Settingclass {
	...
	public static void signup() throws InterruptedException {
		...
		driver.findElement(By.name("Email")).sendKeys("asmitakc8@gmail.com");
		driver.findElement(By.name("Company")).sendKeys("Vividagency");
		driver.findElement(By.name("Password")).sendKeys("hoper1@");
		driver.findElement(By.name("ConfirmPassword")).sendKeys("hoper1@");
	...
	public static void deleteaddress() throws InterruptedException {
		...
		System.out.println("Alert Text:+altinfo");
		alert.accept();
		Thread.sleep(5000);
		address();
	}
